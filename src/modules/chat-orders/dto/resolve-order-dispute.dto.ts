...
export class ResolveOrderDisputeDto {
  @ApiProperty({
    ...
    description:
      'Résolution du litige : rembourser le PRO (acheteur) ou payer le testeur (vendeur)',
    example: 'PAY_SELLER',
  })
  ...
  @ApiProperty({
    ...
    example:
      'Après examen des preuves de livraison, le contenu correspond aux attentes. Paiement libéré au testeur.',
    maxLength: 2000,
  })
  @IsString()
  @IsNotEmpty()
