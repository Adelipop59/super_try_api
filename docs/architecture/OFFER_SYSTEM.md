...
```json
{
  ...
  "maxReimbursedPrice": 30.0, // Max 30€ remboursés
  "reimbursedShipping": true,
  "maxReimbursedShipping": 3.0, // Max 3€ remboursés
  "bonus": 10.0,
  "quantity": 50
}
```
...
```json
{
  ...
  "reimbursedShipping": true,
  "maxReimbursedShipping": null, // Remboursement total
  "bonus": 20.0 // ⭐ Bonus augmenté pour Black Friday
}
```
...
```json
{
  ...
  "productId": "prod-ecouteurs",
  "reimbursedPrice": true,
  "maxReimbursedPrice": 40.0, // Max 40€ remboursés
  "reimbursedShipping": true,
  "maxReimbursedShipping": 5.0, // Max 5€ remboursés
  "bonus": 10.0 // Bonus normal
}
```
...
```json
{
  ...
  "offers": [
    ...
    },
    {
      ...
      "reimbursedPrice": true,
      "maxReimbursedPrice": 80.0, // Max 80€
      "reimbursedShipping": true,
      "maxReimbursedShipping": 10.0, // Max 10€
      "bonus": 25.0,
    ...
    },
    {
      ...
      "maxReimbursedShipping": null,
      "bonus": 50.0, // Bonus uniquement (garde le produit)
