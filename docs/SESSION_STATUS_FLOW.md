...
1-8. (Identique)
9. PRO valide et demande UGC → **UGC_REQUESTED**
10. USER soumet vidéo TikTok → **UGC_SUBMITTED**
11. PRO valide UGC → **PENDING_CLOSURE**
12. PRO clôture → **COMPLETED**
13. 💰 Paiement : 1195€ + 5€ + 50€ + 50€ (bonus UGC) = 1300€

### Scénario avec litige

1-6. (Identique)
7. USER complète étapes mais PRO conteste qualité photos
8. USER crée litige → **DISPUTED**
9. ADMIN examine, demande nouvelles photos
10. USER soumet nouvelles photos
11. ADMIN résout → **PROCEDURES_COMPLETED**
12. (Continue normalement)
