...
1. ✅ **Compte actif** (`isActive = true`)
   ...
   - Message d'erreur : _"Your account has been suspended. Please contact support for more information."_

2. ✅ **Vérification KYC complétée** (`verificationStatus = 'verified'`)
   - Si `verificationStatus != 'verified'` → Le testeur **ne peut pas postuler**
   - Message d'erreur : _"You must complete identity verification before applying to campaigns. Please verify your identity in your profile settings."_
